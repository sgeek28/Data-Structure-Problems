...
int main()
{
	...
	int i,n,ch;
	printf("Insert the number of nodes that you want in a binary tree\n");
	scanf("%d",&n);
	int a[n];
	for(i=0;i<n;i++)
		a[i]=rand()%100;
	...
	do{
		...
		switch(ch)
		{
			...
			case 2: {
				...
				printf("\nNo. of level=%d",countlevel(root_0));
			...
			case 3: {
				...
				printf("\nNo. of level=%d",countlevel(root_1));
			...
			case 4: {
				...
				printf("\nNo. of level=%d",countlevel(root_2));
			...
			case 5:{
				...
				printf("\nNo. of level=%d",countlevel(root_3));
